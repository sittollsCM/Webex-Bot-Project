...
framework.hears(
  "Miras",
  (bot) => {
    console.log("User is asking for Miras!");
    bot.say(
      "markdown",
      "Miras Baigashev - IT2-2101, Developer and Operator, \n Student ID: 31133"
    );
  },
  "**Miras**: (learn more about Miras)",
  0
);
...
framework.hears(
  "Diana",
  (bot) => {
    console.log("User is asking for Diana!");
    bot.say(
      "markdown",
      "Diana Sarsembayeva - IT2-2101, Developer and Operator, \n Student ID: 31130"
    );
  },
  "**Diana**: (learn more about Diana)",
  0
);

// Future requests (webex api integrations)
// framework.hears(
//   "schedule",
//   (bot) => {
...
//     );
//   },
//   "**schedule a meeting**: (for scheduling a meeting)",
//   0
// );
...
//   "invite",
//   (bot) => {
//     console.log("invite is called");
//     bot.say(
//       "markdown",
//       ""
//     );
//   },
//   "**invite**: (to invite participants to a room/meeting)",
//   0
// );
...
/*
  STOP THE BOT USING SPECIAL CODE
*/
framework.hears(
  "stop",
  (bot) => {
    console.log("BOT SHUTDOWN INITIATED, CODE REQUIRED");
    bot.say('You want to shut me down? If so, provide a termination code please..'
    );
  },
  "**stop**: (STOPPING THE BOT - SPECIAL ADMIN CODE REQUIRED!!! )",
  0
);
// CODE INSERTED - '/killbot'
framework.hears(
  "/killbot",
  (bot) => {
    console.log("-----BOT SHUTDOWN APPROVED, SHUTTING DOWN!-----");
    bot.say('Goodbye...SHUTTING DOWN');
...
app.get("/", (req, res) => {
  ...
  <body> \
      <h1> \
          Welcome to the bot localhost page! <br>\
